 ...
 *
 * Multiverb class. Multiverb objects can be used to add a reverb
 * effect to a monaural or stereo audio stream. It is assumed that
 * the audio samples are of type float.
 *
*/
